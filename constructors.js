...
function Employee(name, email, hireDate) {
  ...
  */
  ...
  /*
    ...
    name (a string), genre (a string), and rating (a number withing 1-100 that has been
    averaged out from previous given ratings).
  ...
  */
  ...
  Movie.prototype.changeRating = function(num){
    this.rating.reduce(function(acc, cur){
      // return acc + cur / rating.length
    })
  }
  ////////// PROBLEM 5 //////////
  ...
  // Name and email will be strings, age will be a number and savedPosts will be an 
  // array of objects. 
  // These objects will each have 3 properties: 
  ...
  // write a prototype method for the User function. 
  // Name this method addSavedPost. 
  // It should take in three parameters: 
  // id (a number), title (a string) and rating (a number). 
